...
!!! note "Get an IC card the moment you land"
...
!!! tip "Use Google Maps for live transit"
...
The limousine bus is still the best option on the way out too, but it needs to be **reserved by 7 PM JST the day before** through the [Kantetsu Express Bus site](https://www.kantetsu.co.jp/en/lang/expressbus/tsukuba-nrt){ target="_blank" }.
...
|---|---|---|
| :material-gate: **Front** | Namiki-2-chome bus stop | Main entry, closest to the bus stop |
| :material-gate: **North** | Doho Park | Several restaurants nearby *(more in [Food section](food.md))* |
| :material-gate: **South** | 7-Eleven | Handy for anything last-minute *(more in [Shopping section](shopping.md))* |

<small>An official map is available online.</small>
...
=== "AIST shuttle"
    ...
    <small>An official schedule is available online.</small>
